...
import '../../stages/view/stages_view.dart';
import '../../approval/view/approval_view.dart';
...
class DashboardView extends StatelessWidget {
  ...
  void _navigateTo(BuildContext context, String route) {
    ...
    switch (route) {
      case '/students':
        screen = const StudentsView();
        break;
      case '/stages':
        screen = const StagesView();
        break;
      case '/approval':
        screen = const ApprovalView();
        break;
      case '/notifications':
      ...
      builder: (context, controller, child) {
        return Scaffold(
          ...
          drawer: AppDrawer(
            ...
            onItemSelected: (route) => _navigateTo(context, route),
          ),
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                children: [
                                  ElevatedButton(
                                    onPressed: () => _navigateTo(context, '/students'),
                                  ...
                                  const SizedBox(height: 8),
                                  ElevatedButton(
                                    onPressed: () => _navigateTo(context, '/approval'),
                                    style: ElevatedButton.styleFrom(
                                      minimumSize: const Size.fromHeight(40),
                                    ),
                                  ...
                                  const SizedBox(height: 8),
                                  ElevatedButton(
                                    onPressed: () => _navigateTo(context, '/stages'),
                                    style: ElevatedButton.styleFrom(
                                      minimumSize: const Size.fromHeight(40),
                                    ),
